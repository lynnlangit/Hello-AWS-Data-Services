...
Image below from AWS blog post (listed below) shows example data mesh architecture on AWS.
...
<img src="https://github.com/lynnlangit/Hello-AWS-Data-Services/blob/master/images/aws-mesh-arch.png" width=1000>
