...
-- 2. Identify EC2 hosts with CPU utilization that is higher by 10 % or more compared 
-- to the average CPU utilization of the entire fleet for the past 2 hours
